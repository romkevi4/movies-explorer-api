...
module.exports.MESSAGE = {
  ...
  CARD_NOT_FOUND: 'Запрашиваемая карточка фильма не найдена',
  ERROR_CREATE_CARD: 'Переданные данные для создания новой карточки фильма не корректны',
  ERROR_DELETE_CARD: 'Удаление карточки фильма другого пользователя запрещено',
  ERROR_DUPLICATE_MOVIE_CARD: 'Фильм с таким наименованием уже есть в базе',
